...
<h1 style="font-size:3.5rem;"> PUMP: Power Under Multiplicity Project </h1>


<h2 style="font-size:1.5rem;">Kristen Hunter<sup>1</sup>, Luke Miratrix<sup>1,2</sup>, <br>
Kristin Porter<sup>3</sup>, Zarni Htet <sup>3</sup></h2>

<h3 style="font-size:1.25rem;">RAND Causal Inference Symposium 2022</h3>

Slides available: github.com/kristenbhunter/presentations/tree/master/RAND2022
...
- **Problem**: Current practice for determining statistical power does not take the use of MTPs into account
...
- Slides: [<span style="color:pink">github.com/kristenbhunter/presentations/tree/master/RAND2022</span>](https://github.com/kristenbhunter/presentations/tree/master/RAND2022)
